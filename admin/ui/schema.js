  ...
  nav: {
    ...
    fields: [
      { key: 'items', kind: 'list-object', label: 'Nav items', summaryKey: 'label', shape: [
        { key: 'id',    kind: 'text', label: 'Anchor id' },
  ...
  hero: {
    ...
    fields: [
      ...
      { key: 'stats', kind: 'list-object', label: 'Stats', summaryKey: 'l', shape: [
        { key: 'k',   kind: 'text', label: 'Number' },
        { key: 'suf', kind: 'text', label: 'Suffix' },
  ...
  services: {
    ...
    fields: [
      ...
      { key: 'items', kind: 'list-object', label: 'Practices', summaryKey: 't', shape: [
        { key: 'n',       kind: 'text', label: 'Number' },
        { key: 't',       kind: 'text', label: 'Title' },
        { key: 'c',       kind: 'text', label: 'Code' },
        { key: 'd',       kind: 'textarea', label: 'Description' },
        { key: 'icon',    kind: 'image', label: 'Icon / illustration', section: 'services' },
  ...
  work: {
    ...
    fields: [
      ...
      { key: 'projects', kind: 'list-object', label: 'Projects', summaryKey: 'title', preview: { route: '/#/work/{id}', idKey: 'id' }, shape: [
        { key: 'id',        kind: 'text', label: 'ID (slug used in /#/work/:id)' },
        { key: 'title',     kind: 'text' },
        { key: 'client',    kind: 'text' },
        { key: 'year',      kind: 'text' },
        { key: 'tag',       kind: 'text', label: 'Tag (e.g. "Health · Screening")' },
        { key: 'variant',   kind: 'text', label: 'Fallback mock variant (used when no thumbnail): analytics | schedule | kanban | map | archive | fleet' },
        { key: 'desc',      kind: 'textarea', label: 'Card description (short)' },
        { key: 'thumbnail', kind: 'image', label: 'Card thumbnail', section: 'work' },
        { key: 'hero',      kind: 'image', label: 'Detail page hero image', section: 'work' },
        ...
        { key: 'gallery',   kind: 'list-image', label: 'Gallery images', section: 'work' },
        { key: 'blocks',    kind: 'list-object', label: 'Body blocks', summaryKey: 'heading', shape: [
          ...
          { key: 'image',   kind: 'image', label: 'Inline image (optional)', section: 'work' },
        ]},
      ]},
    ],
  },
  ...
  team: {
    ...
    fields: [
      ...
      { key: 'members', kind: 'list-object', label: 'Members', summaryKey: 'role', shape: [
        { key: 'role',     kind: 'text' },
        { key: 'initials', kind: 'text' },
        { key: 'n',        kind: 'text', label: 'Number' },
        { key: 'photo',    kind: 'image', label: 'Headshot / photo', section: 'team' },
  ...
  clients: {
    ...
    fields: [
      ...
      { key: 'featured', kind: 'list-object', label: 'Featured clients', summaryKey: 'name', shape: [
        ...
        { key: 'tag',  kind: 'text' },
        { key: 'logo', kind: 'image', label: 'Logo', section: 'clients' },
      ]},
